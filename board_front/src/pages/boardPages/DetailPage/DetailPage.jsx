...
function DetailPage(props) {
    ...
    const comments = useQuery(  // 댓글 조회
        ["commentsQuery"],  // boardId
        async () => {   
    ...
    const commentMutation = useMutation(    // 댓글 작성
        async () => {   
            return await instance.post("/board/comment", commentData);  // boardId, parentId, content
        },
        {
            onSuccess: response => {
    ...
    const deleteCommentMutation = useMutation(    // 댓글 삭제
    ...
    const handleDeleteCommmetButtonOnClick = (commentId) => {
                                ...
                                comments?.data?.data.comments.map(comment =>
                                    <>
                                                ...
                                                <div css={detailButtons}>
                                                    {
                                                        ...
                                                        <div>
                                                            ...
                                                            <button onClick={() => handleDeleteCommmetButtonOnClick(comment.id)}>삭제</button>
                                                        </div>
                                                    }
                                        ...
                                        </div>
                                        {
                                            ...
                                            commentModifyData.commentId === comment.id &&
                                            <div key={comment.id} css={commentWriteBox(comment.level)}>
                                                <textarea name="content" onChange={handleCommentModifyInputOnChange} value={commentModifyData.content} placeholder="수정할 내용을 입력하세요."></textarea>
